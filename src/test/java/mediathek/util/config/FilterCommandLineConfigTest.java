...
import static mediathek.util.config.FilterConfiguration.FILTER_PANEL_AVAILABLE_FILTERS;
import static mediathek.util.config.FilterConfiguration.FilterConfigurationKeys.*;
